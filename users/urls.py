...
from users.views import index, loginPage, inscription, settings, add_mac, show_mac, macapprobation, macdeletion, loginPagePians, loginPagecPians, contactform, admincontrols, about, statutpage, cercle
...
urlpatterns = [
	...
	url(r'^loginPians/$', loginPagePians, name = 'loginPians'),
	url(r'^logincPians/$', loginPagecPians, name = 'logincPians'),
	url(r'^sign-out/$', logout, name = 'sign-out'),
    ...
    url(r'^statut/$', statutpage, name='statutpage'),
	url(r'^cercle/$', cercle, name='cercle'),
