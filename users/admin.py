...
class AdminClient(admin.ModelAdmin):
	list_display = ('nom','prenom','chambre','phone','mail','is_active','has_rezal','is_gadz','is_conscrit','is_superuser','date_fin_abo','credit')
	list_filter = ('is_active','has_rezal','is_gadz','is_conscrit','is_superuser','credit')
	search_fields = ('nom','prenom','chambre','phone')
